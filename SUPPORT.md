...
DRH - Dice Forge status: Development on hold.

Development packages, when available, are distributed separately from this repository.

## Where to ask for help

Use [GitHub Discussions](https://github.com/pacosalasv/DRH_Dice_Studio-Support/discussions) for installation questions, workflow guidance, report interpretation, compatibility checks, and general product feedback.

Use [GitHub Issues](https://github.com/pacosalasv/DRH_Dice_Studio-Support/issues/new/choose) for reproducible bugs, regressions, compatibility problems, focused feature requests, and distribution or listing problems.
